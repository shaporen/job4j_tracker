...
public class BankService {
    ...
    /**
     * Метод принимает: паспорт и реквизит счета отправителя, паспорт и реквизит счета получателя, сумму перевода.
     * Если находит счета отправителя и получателя, проверяет наличие средств и осуществляет перевод получателю
